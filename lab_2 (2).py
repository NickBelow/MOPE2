...
#first = [-1, -1, random.randint (9, 20), random.randint (9, 20), random.randint (9, 20), random.randint (9, 20),
        # random.randint (9, 20)]
#second = [1, -1, random.randint (9, 20), random.randint (9, 20), random.randint (9, 20), random.randint (9, 20),
 #         random.randint (9, 20)]
#third = [-1, 1, random.randint (9, 20), random.randint (9, 20), random.randint (9, 20), random.randint (9, 20),
  #       random.randint (9, 20)]
...
#натурализация уравения регрессии
